...
export const Phase1Scene = memo(function Phase1Scene({ highlightedPhotoId }: Phase1SceneProps) {
  ...
  return (
    <group>
      ...
      <ModelLoader
        src={modelRegistry['phase1/bahareque-house-short'].path}
        fallback={<BaharequeHouse position={[-4.2, 0, -4.8]} rotationY={0.18} variant="short" wallColor="#8b5e3c" scale={0.62} />}
        scale={0.62}
      />
      <ModelLoader
        src={modelRegistry['phase1/bahareque-house-medium'].path}
        fallback={<BaharequeHouse position={[3.8, 0, -4.4]} rotationY={-0.22} variant="medium" wallColor="#7a4e2e" roofColor="#4a2f14" scale={0.62} />}
        scale={0.62}
      />
      <ModelLoader
        src={modelRegistry['phase1/bahareque-house-long'].path}
        fallback={<BaharequeHouse position={[-1.2, 0, -7.2]} rotationY={0.08} variant="long" wallColor="#9a6b44" scale={0.62} />}
        scale={0.62}
      />
      <ModelLoader
        src={modelRegistry['phase1/bahareque-house-medium'].path}
        fallback={<BaharequeHouse position={[5.2, 0, 3.6]} rotationY={-0.42} variant="medium" wallColor="#8b5e3c" scale={0.62} />}
        scale={0.62}
      />
      <ModelLoader
        src={modelRegistry['phase1/bahareque-house-short'].path}
        fallback={<BaharequeHouse position={[-5.8, 0, 3.8]} rotationY={0.32} variant="short" wallColor="#7a5a3a" roofColor="#5a3a18" scale={0.62} />}
        scale={0.62}
      />
      <ModelLoader
        src={modelRegistry['phase1/bahareque-house-long'].path}
        fallback={<BaharequeHouse position={[-8.4, 0, -5.2]} rotationY={0.52} variant="long" wallColor="#8b6a4a" scale={0.62} />}
        scale={0.62}
      />
      <ModelLoader
        src={modelRegistry['phase1/bahareque-house-medium'].path}
        fallback={<BaharequeHouse position={[8.2, 0, 2.8]} rotationY={-0.62} variant="medium" wallColor="#9a7a5a" scale={0.62} />}
        scale={0.62}
      />
      <ModelLoader
        src={modelRegistry['phase1/bahareque-house-short'].path}
        fallback={<BaharequeHouse position={[-2.8, 0, 6.8]} rotationY={0.12} variant="short" wallColor="#7a5a3a" scale={0.62} />}
        scale={0.62}
      />
      <ModelLoader
        src={modelRegistry['phase1/bahareque-house-long'].path}
        fallback={<BaharequeHouse position={[2.2, 0, 9.2]} rotationY={-0.18} variant="long" wallColor="#8b6b4e" scale={0.62} />}
        scale={0.62}
      />
      <ModelLoader
        src={modelRegistry['phase1/bahareque-house-medium'].path}
        fallback={<BaharequeHouse position={[-6.8, 0, 6.2]} rotationY={0.42} variant="medium" wallColor="#8b5e3c" scale={0.62} />}
        scale={0.62}
      />
