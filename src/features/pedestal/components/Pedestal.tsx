  ...
  return (
    <group position={[0, 0, 0]}>
      ...
      <mesh position={[0, 0.65, 0]}>
        ...
        <meshStandardMaterial color="#3d2b12" roughness={0.8} wireframe={false} transparent opacity={0.0} />
      </mesh>
      ...
      {/* Golden inlay ring on floor */}
      <mesh ref={ringRef} rotation-x={-Math.PI / 2} position={[0, 0.02, 0]} receiveShadow>
        <ringGeometry args={[1.55, 1.68, 64]} />
        <meshStandardMaterial color="#c9a86a" emissive="#ffb400" emissiveIntensity={0.35} roughness={0.4} metalness={0.7} side={THREE.DoubleSide} />
      </mesh>
      {/* Second ring */}
      ...
      <spotLight position={[0, 6, 0]} angle={0.35} penumbra={0.6} intensity={18} color="#ffe9a0" distance={12} decay={1.5} castShadow shadow-mapSize={[1024, 1024]} />
