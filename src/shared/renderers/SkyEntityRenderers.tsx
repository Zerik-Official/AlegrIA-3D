 ...
 * scaling or restyling them never needs code. Registered by type in
 * `shared/renderers/skyRenderers`.
 * @module shared/renderers/SkyEntityRenderers
 */
 ...
 * @returns Sun group
 */
export function SunRenderer({ entity }: EntityRendererProps) {
 ...
 * @returns Cloud group
 */
export function CloudRenderer({ entity }: EntityRendererProps) {
