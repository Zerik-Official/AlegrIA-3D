...
export const modelRegistry: ModelRegistry = {
  ...
  'phase1/bahareque-house-short': { path: '/models/phase1/bahareque-house-short.glb', fallback: 'procedural-bahareque-short' },
  'phase1/bahareque-house-medium': { path: '/models/phase1/bahareque-house-medium.glb', fallback: 'procedural-bahareque-medium' },
  'phase1/bahareque-house-long': { path: '/models/phase1/bahareque-house-long.glb', fallback: 'procedural-bahareque-long' },
